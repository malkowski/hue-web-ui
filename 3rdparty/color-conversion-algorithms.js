 ...
 *
 * Note: hslToHsv + hsvToHsl functions were added by me.
 *
 * Original source:
 * https://gist.github.com/mjackson/5311256
 * https://gist.githubusercontent.com/mjackson/5311256/raw/132d6d1f39bf422e03c8ab86b5329d6f4dfbc383/color-conversion-algorithms.js
 */
...
/**
 * Converts an HSV color value to HSL. Conversion formula
 * adapted from http://en.wikipedia.org/wiki/HSV_color_space.
 * Assumes h, s, and v are contained in the set [0, 1] and
 * returns h, s, and l in the set [0, 1].
 *
...
function hsvToHsl(h, s, v) {
	let hsl = _hsv2hsl(h*360,s*100,v*100)
	return [ hsl[0]/360, hsl[1]/100, hsl[2]/100 ]
}

/**
 * Converts an HSL color value to HSV. Conversion formula
 * adapted from http://en.wikipedia.org/wiki/HSV_color_space.
 * Assumes h, s, and l are contained in the set [0, 1] and
 * returns h, s, and v in the set [0, 1].
 *
...
function hslToHsv(h, s, l) {
	let hsv = _hsl2hsv(h*360,s*100,l*100)
	return [ hsv[0]/360, hsv[1]/100, hsv[2]/100 ]
}

/*
 * The following two functions are from
 * https://jonneal.dev/convert-colors/hsl-hsv.js.html
 */
...
*/
function _hsl2hsv(hslH, hslS, hslL) {
...
* @link https://gist.github.com/defims/0ca2ef8832833186ed396a2f8a204117
*/
function _hsv2hsl(hsvH, hsvS, hsvV) {
